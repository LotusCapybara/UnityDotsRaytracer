...
public class UIPanel_Startup : MonoBehaviour
{
    ...
    [SerializeField]
    private TMP_Dropdown _dropdownDiffuseMode;
    
    [SerializeField]
    private TMP_Dropdown _dropdownSpecularMode;
    ...
    private void Start()
    {
        ...
        _dropdownDiffuseMode.options = new List<TMP_Dropdown.OptionData>
        {
            new() { text   = EDiffuseMode.Lambert.ToString() },
            new() { text   = EDiffuseMode.OrenNayar.ToString() },
        };
        _dropdownDiffuseMode.SetValueWithoutNotify(PlayerPrefs.GetInt("dropDiffuseMode", 0));
        ...
        _dropdownSpecularMode.SetValueWithoutNotify(PlayerPrefs.GetInt("dropSpecularMode", 0));
    ...
    private void OnClick_StartTracing()
    {
        ...
        PlayerPrefs.SetInt("dropDiffuseMode", _dropdownDiffuseMode.value);
        PlayerPrefs.SetInt("dropSpecularMode", _dropdownSpecularMode.value);
        ...
        EDiffuseMode.TryParse(_dropdownDiffuseMode.options[_dropdownDiffuseMode.value].text, out EDiffuseMode diffuseMode);
        ESpecularMode.TryParse(_dropdownSpecularMode.options[_dropdownSpecularMode.value].text, out ESpecularMode specularMode);
        ...
        _raytracer.StartTracing(
            new TracerSettings
            {
                ...
                indirectBounces = (int)  _sliderBounces.value,
